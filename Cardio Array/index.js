...
const dates = inventors.filter(({ year }) => year < 1600 && year > 1500)
console.table(dates)
// Array.prototype.map()
...
const sortDates = inventors.sort((a, b) => a.year > b.year ? 1 : -1)
console.log(sortDates);
// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const years = inventors.reduce(((total, { year, passed }) => total + (passed - year)), 0)
console.log(years);
...
// const listOfLinks = document.querySelector('.mw-category')
// const links = [...listOfLinks.querySelectorAll('a')]
